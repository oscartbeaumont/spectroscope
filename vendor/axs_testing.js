...
goog.define = function (a, b) {
  ...
  COMPILED ||
    ...
    Object.prototype.hasOwnProperty.call(goog.global.CLOSURE_UNCOMPILED_DEFINES, a)
    ...
    if (goog.global.eval) {
      if (
        (null == goog.evalWorksForGlobals_ &&
          ...
          "undefined" != typeof goog.global._et_
...
goog.base = function (a, b, c) {
  ...
  for (
    var e = Array.prototype.slice.call(arguments, 2), f = !1, g = a.constructor;
    g;
...
axs.constants.ARIA_ROLES = {
  ...
  alertdialog: { namefrom: ["author"], namerequired: !0, parent: ["alert", "dialog"] },
  application: { namefrom: ["author"], namerequired: !0, parent: ["landmark"] },
  article: { namefrom: ["author"], parent: ["document", "region"] },
  ...
  command: { abstract: !0, namefrom: ["author"], parent: ["widget"] },
  complementary: { namefrom: ["author"], parent: ["landmark"] },
  composite: {
    abstract: !0,
  ...
  contentinfo: { namefrom: ["author"], parent: ["landmark"] },
  definition: { namefrom: ["author"], parent: ["section"] },
  dialog: { namefrom: ["author"], namerequired: !0, parent: ["window"] },
  directory: { namefrom: ["contents", "author"], parent: ["list"] },
  document: { namefrom: [" author"], namerequired: !0, parent: ["structure"], properties: ["aria-expanded"] },
  ...
  group: { namefrom: [" author"], parent: ["section"], properties: ["aria-activedescendant"] },
  heading: { namerequired: !0, parent: ["sectionhead"], properties: ["aria-level"] },
  img: { childpresentational: !0, namefrom: ["author"], namerequired: !0, parent: ["section"] },
  input: { abstract: !0, namefrom: ["author"], parent: ["widget"] },
  ...
  math: { childpresentational: !0, namefrom: ["author"], parent: ["section"] },
  menu: {
  ...
  menuitem: { namefrom: ["contents", "author"], namerequired: !0, parent: ["command"] },
  menuitemcheckbox: { namefrom: ["contents", "author"], namerequired: !0, parent: ["checkbox", "menuitem"] },
  menuitemradio: { namefrom: ["contents", "author"], namerequired: !0, parent: ["menuitemcheckbox", "radio"] },
  navigation: { namefrom: ["author"], parent: ["landmark"] },
  ...
  roletype: {
    abstract: !0,
    properties:
      "aria-atomic aria-busy aria-controls aria-describedby aria-disabled aria-dropeffect aria-flowto aria-grabbed aria-haspopup aria-hidden aria-invalid aria-label aria-labelledby aria-live aria-owns aria-relevant".split(
        " ",
      ),
  },
  row: {
  ...
  rowgroup: { mustcontain: ["row"], namefrom: ["contents", "author"], parent: ["group"] },
  rowheader: {
    namefrom: ["contents", "author"],
    namerequired: !0,
    parent: ["gridcell", "sectionhead", "widget"],
  ...
  section: { abstract: !0, namefrom: ["contents", "author"], parent: ["structure"], properties: ["aria-expanded"] },
  sectionhead: { abstract: !0, namefrom: ["contents", "author"], parent: ["structure"], properties: ["aria-expanded"] },
  select: { abstract: !0, namefrom: ["author"], parent: ["composite", "group", "input"] },
  separator: {
    childpresentational: !0,
    namefrom: ["author"],
    parent: ["structure"],
  ...
  tab: { namefrom: ["contents", "author"], parent: ["sectionhead", "widget"], properties: ["aria-selected"] },
  tablist: {
    mustcontain: ["tab"],
    namefrom: ["author"],
  ...
  tabpanel: { namefrom: ["author"], namerequired: !0, parent: ["region"] },
  textbox: {
    namefrom: ["author"],
    namerequired: !0,
    parent: ["input"],
  ...
  timer: { namefrom: ["author"], namerequired: !0, parent: ["status"] },
  ...
  treegrid: { mustcontain: ["row"], namefrom: ["author"], namerequired: !0, parent: ["grid", "tree"] },
...
axs.constants.ARIA_PROPERTIES = {
  activedescendant: { type: "property", valueType: "idref" },
  atomic: { defaultValue: "false", type: "property", valueType: "boolean" },
  autocomplete: {
    defaultValue: "none",
    type: "property",
    valueType: "token",
  ...
  busy: { defaultValue: "false", type: "state", valueType: "boolean" },
  checked: {
  ...
  describedby: { type: "property", valueType: "idref_list" },
  disabled: { defaultValue: "false", type: "state", valueType: "boolean" },
  dropeffect: {
    defaultValue: "none",
    type: "property",
  ...
  expanded: { defaultValue: "undefined", type: "state", valueType: "token", values: ["true", "false", "undefined"] },
  flowto: { type: "property", valueType: "idref_list" },
  grabbed: { defaultValue: "undefined", type: "state", valueType: "token", values: ["true", "false", "undefined"] },
  haspopup: { defaultValue: "false", type: "property", valueType: "boolean" },
  hidden: { defaultValue: "false", type: "state", valueType: "boolean" },
  invalid: {
    defaultValue: "false",
    type: "state",
    valueType: "token",
  ...
  live: { defaultValue: "off", type: "property", valueType: "token", values: ["off", "polite", "assertive"] },
  multiline: { defaultValue: "false", type: "property", valueType: "boolean" },
  multiselectable: { defaultValue: "false", type: "property", valueType: "boolean" },
  orientation: { defaultValue: "vertical", type: "property", valueType: "token", values: ["horizontal", "vertical"] },
  ...
  readonly: { defaultValue: "false", type: "property", valueType: "boolean" },
  relevant: {
  ...
  required: { defaultValue: "false", type: "property", valueType: "boolean" },
  selected: { defaultValue: "undefined", type: "state", valueType: "token", values: ["true", "false", "undefined"] },
...
axs.constants.ATTRIBUTE_VALUE_TO_STATUS = [
  {
    ...
    values: { inline: "aria_autocomplete_inline", list: "aria_autocomplete_list", both: "aria_autocomplete_both" },
  },
  {
    name: "aria-checked",
    values: { true: "aria_checked_true", false: "aria_checked_false", mixed: "aria_checked_mixed" },
  },
  ...
  {
    name: "aria-invalid",
    values: { true: "aria_invalid_true", grammar: "aria_invalid_grammar", spelling: "aria_invalid_spelling" },
  },
  { name: "aria-multiline", values: { true: "aria_multiline_true" } },
  { name: "aria-multiselectable", values: { true: "aria_multiselectable_true" } },
  {
    name: "aria-pressed",
    values: { true: "aria_pressed_true", false: "aria_pressed_false", mixed: "aria_pressed_mixed" },
  },
  { name: "aria-readonly", values: { true: "aria_readonly_true" } },
  { name: "aria-required", values: { true: "aria_required_true" } },
  { name: "aria-selected", values: { true: "aria_selected_true", false: "aria_selected_false" } },
];
...
axs.utils.calculateContrastRatio = function (a, b) {
  ...
  var c = axs.utils.calculateLuminance(a),
    d = axs.utils.calculateLuminance(b);
...
axs.utils.canScrollTo = function (a, b) {
  var c = a.getBoundingClientRect(),
    ...
    f = d.left,
    g = e - b.scrollTop,
    e = e - b.scrollTop + b.scrollHeight,
    h = f - b.scrollLeft + b.scrollWidth;
  if (c.right < f - b.scrollLeft || c.bottom < g || c.left > h || c.top > e) {
    return !1;
  }
  f = a.ownerDocument.defaultView;
  g = f.getComputedStyle(b);
  return c.left > d.right || c.top > d.bottom
    ? "scroll" == g.overflow || "auto" == g.overflow || b instanceof f.HTMLBodyElement
    : !0;
};
axs.utils.isClippedBy = function (a, b) {
  var c = a.getBoundingClientRect(),
    d = b.getBoundingClientRect(),
    e = d.top - b.scrollTop,
    f = d.left - b.scrollLeft,
    g = a.ownerDocument.defaultView.getComputedStyle(b);
  return (c.right < d.left || c.bottom < d.top || c.left > d.right || c.top > d.bottom) && "hidden" == g.overflow
    ? !0
    : c.right < f || c.bottom < e
    ? "visible" != g.overflow
    : !1;
};
...
axs.utils.elementIsHtmlControl = function (a) {
  ...
  return a instanceof b.HTMLButtonElement ||
...
axs.utils.elementIsAriaWidget = function (a) {
  return a.hasAttribute("role") &&
    (a = a.getAttribute("role")) &&
    (a = axs.constants.ARIA_ROLES[a]) &&
    "widget" in a.allParentRolesSet
    ? !0
    : !1;
};
axs.utils.elementIsVisible = function (a) {
  return axs.utils.elementIsTransparent(a) ||
    axs.utils.elementHasZeroArea(a) ||
    axs.utils.elementIsOutsideScrollArea(a) ||
    axs.utils.overlappingElements(a).length
    ? !1
    : !0;
};
...
axs.utils.parseColor = function (a) {
  ...
  return (b = a.match(/^rgba\((\d+), (\d+), (\d+), (\d+(\.\d+)?)\)/))
    ? ((d = parseInt(b[4], 10)),
      (a = parseInt(b[1], 10)),
      (c = parseInt(b[2], 10)),
      (b = parseInt(b[3], 10)),
      new axs.utils.Color(a, c, b, d))
    : null;
};
...
axs.utils.colorToString = function (a) {
  return 1 == a.alpha
    ? "#" +
        axs.utils.colorChannelToString(a.red) +
        axs.utils.colorChannelToString(a.green) +
        axs.utils.colorChannelToString(a.blue)
    : "rgba(" + [a.red, a.green, a.blue, a.alpha].join() + ")";
};
...
axs.utils.suggestColors = function (a, b, c, d) {
  ...
  var e = {},
    f = axs.utils.calculateLuminance(a),
    g = axs.utils.calculateLuminance(b),
    h = axs.utils.isLargeFont(d) ? 3 : 4.5,
    k = axs.utils.isLargeFont(d) ? 4.5 : 7,
    m = g > f,
    l = axs.utils.luminanceFromContrastRatio(f, h + 0.02, m),
    n = axs.utils.luminanceFromContrastRatio(f, k + 0.02, m),
    q = axs.utils.toYCC(b);
  if (axs.utils.isLowContrast(c, d, !1) && 1 >= l && 0 <= l) {
    var p = axs.utils.translateColor(q, l),
      l = axs.utils.calculateContrastRatio(p, a);
  ...
  axs.utils.isLowContrast(c, d, !0) &&
    1 >= n &&
    0 <= n &&
    ((n = axs.utils.translateColor(q, n)),
    (l = axs.utils.calculateContrastRatio(n, a)),
    (f = {}),
  ...
  a = axs.utils.toYCC(a);
  !("AA" in e) &&
    axs.utils.isLowContrast(c, d, !1) &&
    1 >= h &&
    0 <= h &&
    ((k = axs.utils.translateColor(a, h)),
    (l = axs.utils.calculateContrastRatio(b, k)),
    (f = {}),
    (f.bg = axs.utils.colorToString(k)),
    (f.fg = axs.utils.colorToString(b)),
    (f.contrast = l.toFixed(2)),
    (e.AA = f));
  !("AAA" in e) &&
    axs.utils.isLowContrast(c, d, !0) &&
    1 >= g &&
    0 <= g &&
    ((c = axs.utils.translateColor(a, g)),
    (l = axs.utils.calculateContrastRatio(b, c)),
    (f = {}),
    (f.bg = axs.utils.colorToString(c)),
    (f.fg = axs.utils.colorToString(b)),
    (f.contrast = l.toFixed(2)),
    (e.AAA = f));
  return e;
...
axs.utils.flattenColors = function (a, b) {
  var c = a.alpha;
  return new axs.utils.Color(
    (1 - c) * b.red + c * a.red,
    (1 - c) * b.green + c * a.green,
    (1 - c) * b.blue + c * a.blue,
    a.alpha + b.alpha * (1 - a.alpha),
  );
};
...
axs.utils.RGBToYCCMatrix = function (a, b) {
  return [
    [a, 1 - a - b, b],
    [-a / (2 - 2 * b), (a + b - 1) / (2 - 2 * b), (1 - b) / (2 - 2 * b)],
    [(1 - a) / (2 - 2 * a), (a + b - 1) / (2 - 2 * a), -b / (2 - 2 * a)],
  ];
};
axs.utils.invert3x3Matrix = function (a) {
  ...
  return axs.utils.scalarMultiplyMatrix(
    [
      [f * a - g * k, d * k - c * a, c * g - d * f],
      [g * h - e * a, b * a - d * h, d * e - b * g],
      [e * k - f * h, h * c - b * k, b * f - c * e],
    ],
    1 / (b * (f * a - g * k) - c * (a * e - g * h) + d * (e * k - f * h)),
  );
};
...
axs.utils.fromYCC = function (a) {
  var b = axs.utils.convertColor(axs.utils.INVERTED_YCC_MATRIX, a),
    c = b[0];
  a = b[1];
  b = b[2];
...
axs.utils.hasLabel = function (a) {
  ...
  if (
    ...
    ("img" == b && a.hasAttribute("alt")) ||
    ("input" == b && "image" == c && a.hasAttribute("alt")) ||
    ("input" == b && ("submit" == c || "reset" == c)) ||
    a.hasAttribute("aria-labelledby") ||
    (axs.utils.isNativeTextElement(a) && a.hasAttribute("placeholder")) ||
    (a.hasAttribute("id") && 0 < document.querySelectorAll('label[for="' + a.id + '"]').length)
  ) {
    return !0;
  }
...
axs.utils.isElementHidden = function (a) {
  ...
  return "none" == c.display || "hidden" == c.visibility
    ? !0
    : a.hasAttribute("aria-hidden") && "true" == a.getAttribute("aria-hidden").toLowerCase()
    ? !b
    : !1;
};
axs.utils.isElementOrAncestorHidden = function (a) {
  return axs.utils.isElementHidden(a)
    ? !0
    : axs.utils.parentElement(a)
    ? axs.utils.isElementOrAncestorHidden(axs.utils.parentElement(a))
    : !1;
};
...
axs.utils.getRoles = function (a) {
  ...
  for (var b = [], c = !0, d = 0; d < a.length; d++) {
    var e = a[d];
    axs.constants.ARIA_ROLES[e]
      ? b.push({ name: e, details: axs.constants.ARIA_ROLES[e], valid: !0 })
      : (b.push({ name: e, valid: !1 }), (c = !1));
  }
  return { roles: b, valid: c };
};
axs.utils.getAriaPropertyValue = function (a, b, c) {
  var d = a.replace(/^aria-/, ""),
    e = axs.constants.ARIA_PROPERTIES[d],
    d = { name: a, rawValue: b };
  if (!e) {
  ...
  switch (e) {
    ...
    case "idref_list":
      ...
      for (b = 0; b < a.length; b++) {
        (e = axs.utils.isValidIDRefValue(a[b], c)),
          e.valid || (d.valid = !1),
    ...
    case "decimal":
      ...
      Math.floor(c.value) != c.value
        ? ((d.valid = !1), (d.reason = "" + b + " is not a whole integer"))
    ...
    case "token":
      return (
        (c = axs.utils.isValidTokenValue(a, b.toLowerCase())),
        c.valid ? ((d.valid = !0), (d.value = c.value)) : ((d.valid = !1), (d.value = b), (d.reason = c.reason)),
        d
      );
    case "token_list":
      e = b.split(/\s+/);
      ...
      for (b = 0; b < e.length; b++) {
        (c = axs.utils.isValidTokenValue(a, e[b].toLowerCase())),
          c.valid ||
            ((d.valid = !1),
            d.reason
              ? ((d.reason = [d.reason]), d.reason.push(c.reason))
              : ((d.reason = c.reason), (d.possibleValues = c.possibleValues))),
          d.values ? d.values.push(c.value) : (d.values = [c.value]);
      }
      return d;
    case "tristate":
      return (
        (c = axs.utils.isPossibleValue(b.toLowerCase(), axs.constants.MIXED_VALUES, a)),
        c.valid ? ((d.valid = !0), (d.value = c.value)) : ((d.valid = !1), (d.value = b), (d.reason = c.reason)),
        d
      );
    case "boolean":
      return (
        (c = axs.utils.isValidBoolean(b)),
        c.valid ? ((d.valid = !0), (d.value = c.value)) : ((d.valid = !1), (d.value = b), (d.reason = c.reason)),
        d
      );
  }
...
axs.utils.isPossibleValue = function (a, b, c) {
  return b[a]
    ? { valid: !0, value: a }
    : { valid: !1, value: a, reason: '"' + a + '" is not a valid value for ' + c, possibleValues: Object.keys(b) };
};
axs.utils.isValidBoolean = function (a) {
  ...
  return "boolean" != typeof b
    ? { valid: !1, value: a, reason: '"' + a + '" is not a true/false value' }
    : { valid: !0, value: b };
};
axs.utils.isValidIDRefValue = function (a, b) {
  return 0 == a.length
    ...
    ? { valid: !0, idref: a }
    : { valid: !1, idref: a, reason: 'No element with ID "' + a + '"' };
};
axs.utils.isValidNumber = function (a) {
  ...
  return "number" != typeof b
    ? { valid: !1, value: a, reason: '"' + a + '" is not a number' }
    : { valid: !0, value: b };
};
axs.utils.isElementImplicitlyFocusable = function (a) {
  var b = a.ownerDocument.defaultView;
  return a instanceof b.HTMLAnchorElement || a instanceof b.HTMLAreaElement
    ? a.hasAttribute("href")
    : a instanceof b.HTMLInputElement ||
      a instanceof b.HTMLSelectElement ||
      a instanceof b.HTMLTextAreaElement ||
      a instanceof b.HTMLButtonElement ||
      a instanceof b.HTMLIFrameElement
    ? !a.disabled
    : !1;
};
...
axs.utils.getQuerySelectorText = function (a) {
  ...
  if (a.hasAttribute) {
    ...
    if (a.className) {
      ...
      return 1 == d
        ? axs.utils.getQuerySelectorText(a.parentNode) + " > " + b
        : axs.utils.getQuerySelectorText(a.parentNode) + " > " + b + ":nth-of-type(" + d + ")";
    }
    if (a.parentNode) {
...
axs.properties.getFocusProperties = function (a) {
  ...
  void 0 != c
    ? (b.tabindex = { value: c, valid: !0 })
    : axs.utils.isElementImplicitlyFocusable(a) && (b.implicitlyFocusable = { value: !0, valid: !0 });
  if (0 == Object.keys(b).length) {
    return null;
  }
  var d = axs.utils.elementIsTransparent(a),
    e = axs.utils.elementHasZeroArea(a),
    f = axs.utils.elementIsOutsideScrollArea(a),
    g = axs.utils.overlappingElements(a);
  if (d || e || f || 0 < g.length) {
    var c = axs.utils.isElementOrAncestorHidden(a),
      h = { value: !1, valid: c };
    d && (h.transparent = !0);
    e && (h.zeroArea = !0);
...
axs.properties.getHiddenReason = function (a) {
  ...
  var c = window.getComputedStyle(a, null);
  return "none" == c.display
    ? { property: "display: none", on: a }
    : "hidden" == c.visibility
    ? { property: "visibility: hidden", on: a }
    : a.hasAttribute("aria-hidden") && "true" == a.getAttribute("aria-hidden").toLowerCase() && !b
    ? { property: "aria-hidden", on: a }
    : axs.properties.getHiddenReason(axs.utils.parentElement(a));
};
...
axs.properties.hasDirectTextDescendant = function (a) {
  for (
    var b = (a.nodeType == Node.DOCUMENT_NODE ? a : a.ownerDocument).evaluate(
...
axs.properties.findTextAlternatives = function (a, b, c, d) {
  ...
  if (a.nodeType == Node.TEXT_NODE) {
    return (
      ...
      (c.lastWord = axs.properties.getLastWord(c.text)),
      (b.content = c),
      a.textContent
    );
  }
  ...
  c.hasAttribute("aria-label") &&
    ((d = { type: "text" }),
    (d.text = c.getAttribute("aria-label")),
    (d.lastWord = axs.properties.getLastWord(d.text)),
    a ? (d.unused = !0) : (e && axs.utils.elementIsHtmlControl(c)) || (a = d.text),
    (b.ariaLabel = d));
  (c.hasAttribute("role") && "presentation" == c.getAttribute("role")) ||
    (a = axs.properties.getTextFromHostLanguageAttributes(c, b, a, e));
  ...
  if (e && axs.utils.elementIsAriaWidget(c)) {
    ...
    if ("slider" == e || "spinbutton" == e) {
      c.hasAttribute("aria-valuetext")
        ? (b.controlValue = { text: c.getAttribute("aria-valuetext") })
        : c.hasAttribute("aria-valuenow") &&
          (b.controlValue = { value: c.getAttribute("aria-valuenow"), text: "" + c.getAttribute("aria-valuenow") });
    }
    if ("menu" == e) {
  ...
  c.hasAttribute("role") &&
    ((e = c.getAttribute("role")),
    (e = axs.constants.ARIA_ROLES[e]) && (!e.namefrom || 0 > e.namefrom.indexOf("contents")) && (d = !1));
  (e = axs.properties.getTextFromDescendantContent(c)) &&
    d &&
    ((d = { type: "text" }),
    (d.text = e),
    (d.lastWord = axs.properties.getLastWord(d.text)),
  ...
  c.hasAttribute("title") &&
    ...
    (e.text = c.getAttribute("title")),
    (e.lastWord = axs.properties.getLastWord(e.lastWord)),
    a ? (e.unused = !0) : (a = e.text),
    (b.title = e));
...
axs.properties.getTextFromAriaLabelledby = function (a, b) {
  ...
  for (
    var d = a.getAttribute("aria-labelledby").split(/\s+/), e = { valid: !0 }, f = [], g = [], h = 0;
    h < d.length;
    h++
  ) {
    var k = { type: "element" },
    ...
    l
      ? ((k.valid = !0),
        (k.text = axs.properties.findTextAlternatives(l, {}, !0)),
        (k.lastWord = axs.properties.getLastWord(k.text)),
        f.push(l.textContent.trim()),
        (k.element = l))
      : ((k.valid = !1), (e.valid = !1), (k.errorMessage = { messageKey: "noElementWithId", args: [m] }));
    g.push(k);
  }
  0 < g.length &&
    ((g[g.length - 1].last = !0),
...
axs.properties.getTextFromHostLanguageAttributes = function (a, b, c, d) {
  if (axs.browserUtils.matchSelector(a, "img")) {
    if (a.hasAttribute("alt")) {
      ...
      (e = { valid: !1, errorMessage: "No alt value provided" }),
        (b.alt = e),
        (e = a.src),
  ...
  if (
    ...
    if (a.hasAttribute("id")) {
      ...
      for (var e = {}, f = [], g = [], h = 0; h < d.length; h++) {
        var k = { type: "element" },
          m = d[h],
          l = axs.properties.findTextAlternatives(m, {}, !0);
...
axs.properties.getAriaProperties = function (a) {
  var b = {},
    c = axs.properties.getGlobalAriaProperties(a),
    d;
    ...
    if (h.details && h.details.propertiesSet) {
      for (d in h.details.propertiesSet) {
        d in c ||
          (a.hasAttribute(d)
            ? ((f = a.getAttribute(d)),
              (c[d] = axs.utils.getAriaPropertyValue(d, f, a)),
              "values" in c[d] && ((f = c[d].values), (f[f.length - 1].isLast = !0)))
            : h.details.requiredPropertiesSet[d] &&
              (c[d] = { name: d, valid: !1, reason: "Required property not set" }));
      }
    }
  }
  0 < Object.keys(c).length && (b.properties = axs.utils.values(c));
...
axs.properties.getTrackElements = function (a, b) {
  var c = a.querySelectorAll("track[kind=" + b + "]"),
    d = {};
  if (!c.length) {
  ...
  for (var e = [], f = 0; f < c.length; f++) {
    var g = {},
      h = c[f].getAttribute("src"),
      k = c[f].getAttribute("srcLang"),
...
axs.AuditRule.collectMatchingElements = function (a, b, c, d) {
  ...
  if (e && "content" == e.localName) {
    ...
    if (e && "shadow" == e.localName) {
      (a = e),
        d
          ? (d = d.olderShadowRoot || a.olderShadowRoot) && axs.AuditRule.collectMatchingElements(d, b, c, d)
...
axs.AuditRule.prototype.run = function (a) {
  a = a || {};
  var b = "ignoreSelectors" in a ? a.ignoreSelectors : [],
    c = "maxResults" in a ? a.maxResults : null,
    d = [];
...
axs.Audit.getRulesCannotRun = function (a) {
  return a.withConsoleApi
    ? []
    : Object.keys(axs.AuditRule.specs)
        .filter(function (a) {
...
axs.Audit.run = function (a) {
  ...
  !axs.Audit.unsupportedRulesWarningShown &&
    a.showUnsupportedRulesWarning &&
    ((e = axs.Audit.getRulesCannotRun(a)),
    0 < e.length &&
      (console.warn(
  ...
  for (e = 0; e < d.length; e++) {
    var f = d[e],
      g = axs.AuditRules.getRule(f);
    if (g && !g.disabled && (b || !g.requiresConsoleAPI)) {
      var h = {},
        k = a.getIgnoreSelectors(g.name);
...
axs.Audit.auditResults = function (a) {
  for (var b = new axs.AuditResults(), c = 0; c < a.length; c++) {
    var d = a[c];
    d.result == axs.constants.AuditResult.FAIL &&
      (d.rule.severity == axs.constants.Severity.SEVERE
        ? b.addError(axs.Audit.accessibilityErrorMessage(d))
        : b.addWarning(axs.Audit.accessibilityErrorMessage(d)));
  }
  return b;
};
...
axs.Audit.accessibilityErrorMessage = function (a) {
  for (
    var b = a.rule.severity == axs.constants.Severity.SEVERE ? "Error: " : "Warning: ",
      b =
        b +
        (a.rule.code +
          " (" +
          ...
          (1 == a.elements.length ? "element" : "elements")),
      b =
        1 == a.elements.length
          ? b + ":"
          : b + (" (1 - " + Math.min(5, a.elements.length) + " of " + a.elements.length + "):"),
      c = Math.min(a.elements.length, 5),
      d = 0;
    d < c;
    d++
  ) {
...
axs.AuditRule.specs.audioWithoutControls = {
  ...
  relevantElementMatcher: function (a) {
...
axs.AuditRule.specs.controlsWithoutLabel = {
  ...
  test: function (a) {
    return axs.utils.isElementOrAncestorHidden(a) ||
      ("input" == a.tagName.toLowerCase() && "button" == a.type && a.value.length) ||
      ("button" == a.tagName.toLowerCase() && a.textContent.replace(/^\s+|\s+$/g, "").length)
      ? !1
      : axs.utils.hasLabel(a)
      ? !1
      : !0;
  },
  code: "AX_TEXT_01",
...
axs.AuditRule.specs.requiredAriaAttributeMissing = {
  ...
  test: function (a) {
    ...
    for (var c = 0; c < b.roles.length; c++) {
      var d = b.roles[c].details.requiredPropertiesSet,
        e;
      for (e in d) {
        if (
          ((d = e.replace(/^aria-/, "")), !("defaultValue" in axs.constants.ARIA_PROPERTIES[d] || a.hasAttribute(e)))
        ) {
          return !0;
        }
      }
...
axs.AuditRule.specs.unfocusableElementsWithOnClick = {
  ...
  severity: axs.constants.Severity.WARNING,
  opt_requiresConsoleAPI: !0,
  relevantElementMatcher: function (a) {
    return a instanceof a.ownerDocument.defaultView.HTMLBodyElement || axs.utils.isElementOrAncestorHidden(a)
      ? !1
      : "click" in getEventListeners(a)
      ? !0
      : !1;
  },
  test: function (a) {
